...
/**
 * Sets a container background for a widget or live activity.
 * Use this to set the background style of a widget or the expanded area of a live activity.
 * @param color - The background color.
 * @param containerBackground - The container background placement. Defaults to 'widget'.
 * @platform ios 17.0+
...
export const containerBackground = (
  color: string,
  containerBackground: 'widget' | 'navigation' | 'tabView' = 'widget'
) => createModifier('containerBackground', { color, containerBackground });
