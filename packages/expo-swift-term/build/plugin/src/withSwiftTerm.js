...
const withSwiftTerm = (config) => {
    return (0, config_plugins_1.withXcodeProject)(config, (config) => {
        ...
        const alreadyAdded = rootObject.packageReferences.some((ref) => ref.comment?.includes("SwiftTerm"));
        if (!alreadyAdded) {
            ...
            project.hash.project.objects.XCRemoteSwiftPackageReference[`${pkgRefUuid}_comment`] = "SwiftTerm";
            ...
            if (appTargetKey) {
                ...
                project.hash.project.objects.XCSwiftPackageProductDependency[`${depUuid}_comment`] = "SwiftTerm";
...
exports.default = withSwiftTerm;
//# sourceMappingURL=withSwiftTerm.js.map